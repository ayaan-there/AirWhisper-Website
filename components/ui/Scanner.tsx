...
const ctxMap = new WeakMap<HTMLElement, ScannerCtx>();
...
const Scanner = ({
  ...
  useEffect(() => {
    ...
    // Track the cursor at the window level so the scanner reacts to the
    // mouse everywhere, even when foreground content sits on top.
  ...
  useEffect(() => {
    ...
    softness, vignette, opacity, scanline, grain, grainIntensity, scanDirection,
    mouseInteraction, mouseRadius, mouseStrength, color1, color2, color3,
  ]);
